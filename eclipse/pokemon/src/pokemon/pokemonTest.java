...
public class pokemonTest {
	public static void main(String[] args) {
		...
		attacker.setType1(fire);
		attacker.setType2(type);
		attacker.setLevel(50);
		attacker.setName("アタッカー");
		defender.setName("ディフェンダー");
		defender.setDefense(100);
		defender.setLevel(50);
		defender.setType1(grass);
		defender.setType2(type);
		Move move = new Move("かえんほうしゃ",90,fire);
		...
		System.out.println(defender.getName() + "は、" + dmg + "のダメージ！");
	}
}
